            ...
            <div className="Help">
                <div className="ul">
                    <div className="helpInfo">
                        ...
                        <li>3. A la par del texto que dice: Editar categoría, se encuentra el botón de "Agregar Categoría " presione el boton para agregar una categoría</li>
                        <li>4. Escriba el nombre de la categoría y agregue una imagen de la categoría</li>
                        <li>5. Presione el boton para agregar la categoría </li>
                    </div>
                    <div className="helpInfo">
